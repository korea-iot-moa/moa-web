...
export default function InformationNaviBar() {
  ...
  return (
    <div css={s.infoNaviBar}>
      <div css={logo.logoBox} onClick={() => navigator('/')}>
      ...
      <div css={s.naviBox}>
        <div css={s.naviDiv}>
          <IoExtensionPuzzle color='#FF7B54' fontSize="25px"/> <p css={s.fontSt}>단기 모임</p>
        </div>
        <div css={s.naviDiv}>
          <BsPuzzleFill color='#FCD572' fontSize="25px"/> <p css={s.fontSt}>정기 모임</p>
        </div>
        <div css={s.naviDiv}>
